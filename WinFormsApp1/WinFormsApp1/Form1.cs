...
namespace WinFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {                   
                    ...
                    if (comboBox1.SelectedIndex == 0) // если выбран режим "Вход"
                    {
                    ...
                    else if (comboBox1.SelectedIndex == 1) // если выбран режим "Регистрация"
                    {
                        int uniqueNumber = FindUniqueNumber(login);
                        if (uniqueNumber == -1)
                        {
        ...
        // формирование параметров для форм и панелей для каждой панели
        ...
        void SetDisign(int number)
        {
            switch (number)
            {
                ...
                case 1: // регистрация пользователя
                    ...
                    break;
                case 2: // панель пользователя
                    Size = new Size(700, 550);
                    Text = "Панель пользователя";
                    panel3.Visible = true;
                    panel3.Location = new Point(0, 0);

                    label10.Text = "Вы вошли как пользовать: " + textBox1.Text;
                ...
                case 4: // панель админа для вывода всех пользователей
        ...
        private void button16_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Вы не можете изменить информацию об администраторе", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                int uniqueNumber = comboBox5.SelectedIndex;
        ...
        void ReadDataExcel()
        {
            ...
            Excel.Workbook excelBook = excelApp.Workbooks.Open(Environment.CurrentDirectory + "\\Data.xlsx");        // открываем excel файл
            ...
            MessageBox.Show("Считывание данных прошло успешно, пользователей в системе: " + StaticUser.counterUsers, "Проверка", MessageBoxButtons.OK);
